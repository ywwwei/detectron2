...
class AccumAMPTrainer(AMPTrainer):
    """
    Add accumulation iterations to AMPTrainer
    """
    def __init__(
        self,
        model,
        ...
        super().__init__(model, data_loader, optimizer, gather_metric_period,grad_scaler,precision)
